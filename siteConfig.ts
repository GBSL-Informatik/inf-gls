...
const getSiteConfig: SiteConfigProvider = () => {
    return {
        title: 'Informatik',
        tagline: 'gls - Gymnasium Biel-Seeland',
        url: 'https://gls.gbsl.website',
        gitHub: {
        ...
        footer: {
            ...
            copyright: `<a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.de">
                            <div style="display: flex; flex-direction: column; align-items: center;">
                              ...
                              <div>
                                Text und Bilder von gls, Ausnahmen sind gekennzeichnet. 
                              </div>
                            </div>
                          </a>
                          <a 
                            ...
                            href="https://github.com/gbsl-informatik/inf-gls/commits/${GIT_COMMIT_SHA}"
                          >
